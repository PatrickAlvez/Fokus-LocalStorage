...
btnRemoverConcluidas.addEventListener('click', () => {
    let li = document.querySelectorAll('.app__section-task-list-item-complete')
    const tarefasFiltered = []
    for (let index = 0; index < tarefas.length; index++) {
        if(!tarefas[index].concluida){
            tarefasFiltered.push(tarefas[index])
        }
    }
...
btnRemoverTodas.addEventListener('click', () => {
    let li = document.querySelectorAll('.app__section-task-list-item')
